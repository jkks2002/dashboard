...
const ButtonKomp = ({Title,Icon,Overlay,OverlayView,OverlayTname})=>{
    ...
    return(
        <div onClick={()=>{Overlay(true); OverlayView(Title); OverlayTname(Title);}} className="w-full p-2"><div className=" hover:bg-[#1c3a48] w-full p-4 cursor-pointer  bg-[#0f202788] rounded-xl border border-[rgba(255,255,255,0.1)] shadow-2xl shadow-[rgba(0,0,0,0.3)] flex flex-col items-center justify-center  "><GetIcon Icon={Icon} /><div className="mt-4 text-sm">{Title}</div></div></div>
    )
}
