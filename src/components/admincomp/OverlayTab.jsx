...
const OverlayTab = ({Closer,View,Tname})=>{
    ...
    return(
        ...
        <div className="absolute z-[20]  w-full  flex flex-col items-center justify-center">
            <div className="  w-5/6 cursor-pointer  bg-[#1c3a48] rounded border border-[rgba(255,255,255,0.1)] shadow-2xl shadow-[rgba(0,0,0,0.5)] flex flex-col items-start justify-top">
