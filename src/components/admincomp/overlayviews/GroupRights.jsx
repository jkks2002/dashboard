...
const GroupRights = ()=>{
    ...
    <div className="w-full   px-8 mt-10 text-white ">
            ...
            <div className="w-full   px-40 mb-4 grid grid-cols-2 gap-6 items-center justify-items-start">
                ...
                <div className="mt-2 border p-2 grid md:grid-cols-5 grid-cols-1 gap-2 border-[rgba(255,255,255,0.12)] text-sm text-gray-400 rounded shadow-inner-2 bg-[rgba(255,255,255,0.1)]">
                    
                    <div className='inline-block w-full md:col-span-4 col-span-1 inset transition-opacity duration-1000 ease-out opacity-80 hover:opacity-100 px-10  bg-[#0f2027] py-2 rounded border border-[rgba(255,255,255,0.1)] mt-2'>
                    ...
                    <div className='inline-block inset transition-opacity duration-1000 ease-out opacity-80 hover:opacity-100 px-10 flex items-center bg-[#0f2027] py-2 rounded border border-[rgba(255,255,255,0.1)] hover:bg-[#214251]  mt-2'>
            ...
            <div className="w-full   px-8 mt-6 text-white ">
                ...
                <div className="w-full grid grid-cols-10 items-start justify-items-start py-2 divide-x divide-[rgba(255,255,255,0.1)] border-b border-[rgba(255,255,255,0.1)]">
                    <div className="w-full md:col-span-5 pl-2 ">Gruppen-Richtlinien</div>
